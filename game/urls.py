...
urlpatterns = patterns('',
     ...
     url(r'^((?P<lang>[\w-]+)/)?user/bot1$', views_user.bot1, name="user.bot1"),
    ...
    ######## Dictator 1 ########
     url(r'^((?P<lang>[\w-]+)/)?user/joc_dictator1_', views_user.joc_dictator1_, name="user.joc_dictator1_"),
     url(r'^((?P<lang>[\w-]+)/)?ws/enviar_accio_dictator1_/(?P<user_id>\d+)/(?P<result>[\w-]+)',views_ws.enviar_accio_dictator1_, name='ws.enviar_accio_dictator1_'),
     url(r'^((?P<lang>[\w-]+)/)?ws/demanar_resultat_dictator1_/(?P<user_id>\d+)',views_ws.demanar_resultat_dictator1_, name='ws.demanar_resultat_dictator1_'),

    ######## Dictator 2 ########
     url(r'^((?P<lang>[\w-]+)/)?user/joc_dictator2_', views_user.joc_dictator2_, name="user.joc_dictator2_"),
     url(r'^((?P<lang>[\w-]+)/)?ws/enviar_accio_dictator2_/(?P<user_id>\d+)/(?P<result>[\w-]+)',views_ws.enviar_accio_dictator2_, name='ws.enviar_accio_dictator2_'),
     url(r'^((?P<lang>[\w-]+)/)?ws/demanar_resultat_dictator2_/(?P<user_id>\d+)',views_ws.demanar_resultat_dictator2_, name='ws.demanar_resultat_dictator2_'),
    ...
    ######## Prisoner 2 ########
    url(r'^((?P<lang>[\w-]+)/)?user/joc_prisoner2_1', views_user.joc_prisoner2_1, name="user.joc_prisoner2_1"),
    url(r'^((?P<lang>[\w-]+)/)?user/joc_prisoner2_2', views_user.joc_prisoner2_2, name="user.joc_prisoner2_2"),
    url(r'^((?P<lang>[\w-]+)/)?user/joc_prisoner2_3', views_user.joc_prisoner2_3, name="user.joc_prisoner2_3"),

    url(r'^((?P<lang>[\w-]+)/)?ws/enviar_accio_prisoner2/(?P<user_id>\d+)/(?P<result>[\w-]+)',views_ws.enviar_accio_prisoner2, name='ws.enviar_accio_prisoner2'),
    url(r'^((?P<lang>[\w-]+)/)?ws/enviar_accio_guess2/(?P<user_id>\d+)/(?P<result>[\w-]+)',views_ws.enviar_accio_guess2, name='ws.enviar_accio_guess2'),
    url(r'^((?P<lang>[\w-]+)/)?ws/demanar_resultat_prisoner2/(?P<user_id>\d+)',views_ws.demanar_resultat_prisoner2, name='ws.demanar_resultat_prisoner2'),

    ######## Snowdrift 1 ########
     url(r'^((?P<lang>[\w-]+)/)?user/joc_snowdrift1_', views_user.joc_snowdrift1_, name="user.joc_snowdrift1_"),
     url(r'^((?P<lang>[\w-]+)/)?ws/enviar_accio_snowdrift1_/(?P<user_id>\d+)/(?P<result>[\w-]+)',views_ws.enviar_accio_snowdrift1_, name='ws.enviar_accio_snowdrift1_'),
     url(r'^((?P<lang>[\w-]+)/)?ws/demanar_resultat_snowdrift1_/(?P<user_id>\d+)',views_ws.demanar_resultat_snowdrift1_, name='ws.demanar_resultat_snowdrift1_'),
